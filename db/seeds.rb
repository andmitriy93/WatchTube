...
video1 = Video.create(title: 'The best MMO RPG game Dota 2', author_id: demo.id)
video2 = Video.create(title: 'John Wick in 30 seconds', author_id: demo.id)
video3 = Video.create(title: 'Marvel Studios Avengers: Infinity War - Big Game Spot', author_id: demo.id)
video4 = Video.create(title: 'MARVEL - best scnese in 30 seconds ', author_id: demo.id)
video5 = Video.create(title: 'MarvelStudios Black Widow | New Trailer', author_id: demo.id)
video6 = Video.create(title: 'Aquaman - Official Trailer 1 - Now Playing in Theaters', author_id: demo.id)
video7 = Video.create(title: "Kobe Bryant's BEST PLAY vs EVERY NBA TEAM in His Career", author_id: demo.id)
video8 = Video.create(title: '1 minute of Italy', author_id: demo.id)
video9 = Video.create(title: 'Interstellar Movie - Offical Trailer', author_id: demo.id)
video10 = Video.create(title: 'Lion King Song 1 minute song', author_id: demo.id)
video11 = Video.create(title: 'Logan | Official Trailer [HD] 20th Century FOX', author_id: demo.id)
video12 = Video.create(title: '1-Minute Meditation | Find Your Focus with this Mini Meditation', author_id: demo.id)
video13 = Video.create(title: 'Lionel Messi the best moments', author_id: demo.id)
video14 = Video.create(title: 'Most Popular Songs 2020', author_id: demo.id)
video15 = Video.create(title: 'Motivation Never Give Up!', author_id: demo.id)
video16 = Video.create(title: 'Story in 1 Minute', author_id: demo.id)
video17 = Video.create(title: "Disney and Pixar's Soul Trailer | Disney+", author_id: demo.id)
video18 = Video.create(title: 'React in 100 Seconds', author_id: demo.id)
video19 = Video.create(title: 'Cristiano Ronaldo Best Perfomances - *ONLY 1 MINUTE*', author_id: demo.id)
video20 = Video.create(title: 'Spongobob Theme Song (With Lyrics)', author_id: demo.id)
