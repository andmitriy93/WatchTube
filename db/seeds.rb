...
# file1 = open('https://youtube-clone-dev.s3-us-west-1.amazonaws.com/avengers.mp4')
file2 = open('https://youtube-clone-seeds.s3-us-west-1.amazonaws.com/dota.mp4')
file3 = open('https://youtube-clone-seeds.s3-us-west-1.amazonaws.com/john_wick1.mp4')
file4 = open('https://youtube-clone-seeds.s3-us-west-1.amazonaws.com/marvel.mp4')
file5 = open('https://youtube-clone-seeds.s3-us-west-1.amazonaws.com/marvel2.mp4')
# file6 = open('https://youtube-clone-dev.s3-us-west-1.amazonaws.com/videoplayback+(1).mp4')
file7 = open('https://youtube-clone-seeds.s3-us-west-1.amazonaws.com/videoplayback.mp4')
